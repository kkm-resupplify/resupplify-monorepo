<template>
  <m-stepper-step-content class="register-company-contact-info-step">
    <template #body>
      <v-form class="register-company-contact-info-step__body">
        <m-text-field
          name="name"
...
.register-company-contact-info-step {
  &__body {
    display: flex;
